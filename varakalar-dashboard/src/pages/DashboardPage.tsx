      ...
      <div className="sticky top-0 -mt-3 sm:-mt-6 -mx-3 sm:-mx-6 px-3 sm:px-6 py-2.5 sm:py-3.5 mb-6 z-20 bg-white/[0.98] dark:bg-slate-900/[0.98] backdrop-blur-2xl border-b-2 border-indigo-600 dark:border-indigo-500 shadow-xl transition-all">
        <div className="mx-auto max-w-7xl flex flex-col md:flex-row items-start md:items-center justify-between gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-2.5 sm:gap-3 w-full md:w-auto justify-between md:justify-start min-w-0">
            <div className="size-8 sm:size-10 rounded-xl bg-indigo-100 dark:bg-indigo-950/80 text-indigo-700 dark:text-indigo-400 flex items-center justify-center shrink-0 border border-indigo-300 dark:border-indigo-700 shadow-sm">
            ...
            <div className="min-w-0 flex-1">
              <div className="text-[10px] sm:text-[11px] font-bold text-indigo-900 dark:text-indigo-300 uppercase">
              ...
              <div className="text-xs sm:text-sm font-semibold truncate flex flex-wrap items-center gap-1.5 mt-0.5">
                <span className="bg-indigo-50 dark:bg-indigo-950/80 text-indigo-950 dark:text-indigo-100 border border-indigo-200 dark:border-indigo-700 px-2 py-0.5 rounded-md font-bold shadow-sm text-xs sm:text-sm">
                  {dateRangeText}
                </span>
                {sonGuncellemeTarihi && (
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-3 w-full md:w-auto justify-between md:justify-end">
            <div className="flex items-center gap-1.5 sm:gap-2 bg-slate-100 dark:bg-slate-800 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-xl border border-slate-300 dark:border-slate-700 shadow-sm">
              <label htmlFor="year-select" className="text-[11px] sm:text-xs font-bold text-slate-800 dark:text-slate-200">Yıl:</label>
              <select
                id="year-select"
                value={selectedYear}
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 bg-slate-100 dark:bg-slate-800 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-xl border border-slate-300 dark:border-slate-700 shadow-sm">
              <label htmlFor="month-select" className="text-[11px] sm:text-xs font-bold text-slate-800 dark:text-slate-200">Ay:</label>
              <select
                id="month-select"
                value={selectedMonth}
            ...
            {!isExporting && (
              <button
                ...
                className="flex items-center gap-1 sm:gap-1.5 px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl transition-transform duration-150 text-xs font-bold shadow-sm active:scale-95 shrink-0"
                aria-label="Dashboard raporunu PDF olarak indir"
              >
